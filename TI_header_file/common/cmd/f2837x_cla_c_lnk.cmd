...
PAGE 1 :
   ...
   RAMGS12_13_14     : origin = 0x018000, length = 0x003000
/*
...
#error Add either "RAM" or "_FLASH" to C2000 Linker -> Advanced Options -> Command File Preprocessing -> --define
   ...
   .bss              : > RAMGS5_6,              PAGE = 1
   .data             : > RAMGS5_6,		PAGE = 1
   .sysmem           : > RAMGS7,                PAGE = 1
   Test_memory	     : > RAMGS12_13_14     ,	PAGE = 1
}
