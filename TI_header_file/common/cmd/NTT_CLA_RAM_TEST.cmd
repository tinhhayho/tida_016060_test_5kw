...
PAGE 0 :
   ...
   // this block ram is containt .text for CLA
   RAMLS1          	: origin = 0x008800,   length = 0x000800

   RAMTEXT			: origin = 0x009800, length	 = 0x002800
   /*
   ...
   // as reset state -> CPU1 is master of this block ram below
   // it is contain .text c28
...
SECTIONS
{
   ...
   CpuToCla1MsgRAM  : > CLA1_MSGRAMHIGH,  PAGE = 1
	...
	Test_memory		: > RAMGS8_9_10, PAGE = 1
